                         ...
                         <?php if(!empty($all_solutions)){ 
							...
							<div class="col-sm-12">
								...
								<div class="blog-text">
									...
									<span> on <?php echo date('d M Y',strtotime($all['created_at'])) ?></span></strong>
									<span>&nbsp;&nbsp;&nbsp;&nbsp;<a  download href="<?php echo base_url('assets/files/').$all['file'] ?>"><span>Download Attachment </span></a></span>
									<br>
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="blog-text">
												<strong><span>Shared by <?php echo $all['name'] ?></span>
												<span> on <?php echo date('d M Y',strtotime($all['created_at'])) ?></span></strong>
												<span>&nbsp;&nbsp;&nbsp;&nbsp;<a  download href="<?php echo base_url('assets/files/').$all['file'] ?>"><span>Download Attachment </span></a></span><br>
												<p style="border-style: outset;min-height: 200px;"><br><?php echo $all['solution']; ?></p>
											</div>
										</div>
									</div> <br><br>
